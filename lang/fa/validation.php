...
return [
    ...
    'accepted_if'     => 'وقتی :other برابر با :value باشد، فیلد :attribute باید پذیرفته شود.',
    ...
    'ascii'           => 'فیلد :attribute باید فقط شامل کاراکترها و نمادهای تک‌بایتی الفبایی باشد.',
