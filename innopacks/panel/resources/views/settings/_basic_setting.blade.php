...
<div class="tab-pane fade show active" id="tab-setting-basics">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <x-common-form-input title="{{ __('panel/setting.email') }}" name="email"
                value="{{ old('email', system_setting('email')) }}" placeholder="{{ __('panel/setting.email') }}" />
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-4">
                        <x-common-form-switch-radio title="{{ __('panel/setting.header_top_enable') }}"
                            name="header_top_enable" required
                            value="{{ old('header_top_enable', system_setting('header_top_enable', true)) }}" />
                        <div class="text-secondary"><small>{{ __('panel/setting.header_top_enable_desc') }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        <x-common-form-input title="{{ __('panel/setting.header_top_bg_color') }}"
                        ...
                        <div class="text-secondary"><small>{{ __('panel/setting.header_top_bg_color_desc') }}</small>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-4">
                        <x-common-form-input title="{{ __('panel/setting.header_top_instagram') }}"
                            name="header_top_instagram"
                        ...
                        <div class="text-secondary"><small>{{ __('panel/setting.header_top_instagram_desc') }}</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        <x-common-form-input title="{{ __('panel/setting.header_top_telegram') }}"
                            name="header_top_telegram"
                        ...
                        <div class="text-secondary"><small>{{ __('panel/setting.header_top_telegram_desc') }}</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <x-common-form-input title="{{ __('panel/setting.meta_title') }}" name="meta_title" :value="old('meta_keywords', system_setting('meta_title'))"
                :multiple="true" />

            <x-common-form-input title="{{ __('panel/setting.meta_keywords') }}" :multiple="true"
                name="meta_keywords" :value="old('meta_keywords', system_setting('meta_keywords'))" placeholder="{{ __('panel/setting.meta_keywords') }}" />

            <x-common-form-textarea title="{{ __('panel/setting.meta_description') }}" name="meta_description"
                :multiple="true" :value="old('meta_description', system_setting('meta_description'))" placeholder="{{ __('panel/setting.meta_description') }}" />
        </div>
    </div>
</div>
