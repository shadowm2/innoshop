...
<head>
  ...
  <meta name="description"
        content="@yield('description', system_setting_locale('meta_description', 'innoshop یک پلتفرم تجارت الکترونیک منبع باز نوآورانه است که بر اساس Laravel 12 توسعه یافته و دارای ویژگی‌های پشتیبانی چند زبانه و چند ارزی است. این سیستم از معماری افزونه‌ای قدرتمند و انعطاف‌پذیر مبتنی بر Hook استفاده می‌کند و قابلیت‌های غنی سفارشی‌سازی و توسعه را برای کاربران فراهم می‌کند. innoshop را تجربه کنید و پلتفرم تجارت الکترونیک خود را بسازید!'))">
  <meta name="keywords"
        content="@yield('keywords', system_setting_locale('meta_keywords', 'innoshop, نوآورانه, منبع باز, تجارت الکترونیک, تجارت الکترونیک بین‌المللی, سایت مستقل منبع باز, Laravel 12, چند زبانه, چند ارزی, Hook, معماری افزونه, انعطاف‌پذیر, قدرتمند'))">
  ...
  <style>
    ...
    body {
      background-color: {{ system_setting('page_bg_color', '#ffffff') }};
    }
