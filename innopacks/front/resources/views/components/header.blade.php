...
<header id="appHeader">
  <div class="header-top"
       @if (system_setting('header_top_enable', true)) style="display: flex; background-color: {{ system_setting('header_top_bg_color', '#1B1F22') }};"
      ...
      <div class="top-info d-flex align-items-center">
        @if (system_setting('header_top_instagram'))
          <a href="https://instagram.com/{{ system_setting('header_top_instagram') }}" target="_blank"
            ...
            {{ system_setting('header_top_instagram') }}
          </a>
        @endif
