<div class="container mt-3 mt-md-5">
  <div class="row">
    <div class="col-12 col-md-9">
            ...
            <div class="newest-item">
              ...
              <div class="item-content d-flex flex-column justify-content-between">
                <div class="content-top">
                  <div class="item-title mt-2"><a href="{{ $article->url }}">{{ $article->translation->title }}</a>
                  </div>
      ...
      @else
        @include('shared.no-data', ['text' => 'داده‌ای موجود نیست.'])
      @endif
    </div>
        ...
        <div class="search-box">
          <div class="input-group input-group-lg">
            <input type="text" class="form-control" value="{{ request('keyword') }}"
                   placeholder="{{__("front/article.keyword")}}">
