                        ...
                        <div class="swiper-slide">
                            <a href="{{ $image['link']['link'] ?? 'javascript:void(0)' }}" class="slideshow-link">
                             ...
                             font-size: {{ $image['title_size'] ?? 32 }}px;">
                                            {{ $image['title'][front_locale_code()] ??
                                                (is_string($image['title']) ? $image['title'] : $image['title'][array_key_first($image['title'])] ?? '') }}
                                        </h2>
                                    @endif
                             ...
                             font-size: {{ $image['subtitle_size'] ?? 24 }}px;">
                                            {{ $image['subtitle'][front_locale_code()] ??
                                                (is_string($image['subtitle'])
                                                    ? $image['subtitle']
                                                    : $image['subtitle'][array_key_first($image['subtitle'])] ?? '') }}
